...
app.post('/edit/:id',async(req,res)=>{
    try {
        ...
        let db= client.db('userInterFace');
        //console.log("create")
        let user= await db.collection('users').replaceOne({_id: mongodb.ObjectId(req.params.id)},req.body);
        client.close();
        //console.log(user)
        res.json({
...
app.get('/users/:id',async(req,res)=>{
    try {
        ...
        let db= client.db('userInterFace');
        //console.log("create")
        let user= await db.collection('users').findOne({_id: mongodb.ObjectId(req.params)}).toArray();
        client.close();
        //console.log(user)
        res.json(user)
    } catch (error) {
